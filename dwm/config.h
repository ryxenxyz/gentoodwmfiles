...
static const char col_mid[]   = "#777777";
static const char col_light[] = "#dddddd";
...
/* gaps */
static const unsigned int gappx = 20;  /* gap size */
static const int smartgaps = 0;      /* remove outer gap when only one window */
...
static const char *shotcmd[] = {
    ...
    "scrot -s ~/Pictures/%Y-%m-%d_%H-%M-%S.png \
     && notify-send 'Screenshot saved' 'Saved to ~/Pictures'",
    NULL
};
